            ...
            <div class="col">
                <div class="w-full p-6 fw-bold">
                    <div class=" control mb-3">
                        <label for="post"  class="form-label"><i class="fas fa-book-open" style="font-size: x-large"></i> New Post</label>
                        <textarea class="form-control" id="post" name="post" rows="3" type="text"></textarea>

                      </div>
                    <div class=" fw-bold control mb-3 ">
                        <i class="fas fa-image" style="font-size: x-large"></i> Select a Image for your post  <input type="file" name="image" class="form-control" id="image">
                    </div>
