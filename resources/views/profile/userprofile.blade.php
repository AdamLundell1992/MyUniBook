        ...
        <div class="row">
            <div class="col-md-4">
                <div class="profile-work">
                    <p class="fw-bold pb-2" style="font-size: large"><i class="fas fa-info-circle"
                                                                        style="font-size: x-large"></i> About me</p>
                    {{$user->user_info}}
            ...
            <div class="col-md-8">
                <div class="tab-content profile-tab" id="myTabContent">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <p><i class="far fa-calendar-alt" style="font-size: x-large"></i> {{$user->date_of_birth}}
                            </p>
                        </div>
                    </div>
                    <div class="row">
        ...
        <div class="row ">
            <div class="">
                <a href="{{url('addfriend' . '/'. $user->id . '/')}} " class="p-xxl-5 profile-link">
                    <button class="btn btn-primary btn-sm " type="submit" value="yes"><i class="fas fa-user-plus"
            ...
            <div class="col-5">
                <a href="{{url('deleteFriend' . $user->id . '/')}}" class=" profile-link">
                    <button class="btn btn-primary btn-sm"><i class="fas fa-trash-alt" style="font-size: x-large"></i>
